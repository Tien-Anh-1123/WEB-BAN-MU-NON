...
const AdminRoutes = [
  {
    ...
    element: (
      <Suspense fallback={<Loading />}>
        <AuthWrapperAdmin>
          <Page title={"Mũ Nón Chất | Đăng Nhập Admin"}>
            <AuthRoute>
              <LoginAdmin />
            </AuthRoute>
          </Page>
  ...
  },
  {
    ...
    element: (
      <Suspense fallback={<Loading />}>
        <AuthWrapperAdmin>
          <Page title={"TEELAB | Quản lý sản phẩm"}>
  ...
  },
  {
    ...
    element: (
      <Suspense fallback={<Loading />}>
        <AuthWrapperAdmin>
          <Page title={"TEELAB | Thêm sản phẩm"}>
  ...
  },
  {
    ...
    element: (
      <Suspense fallback={<Loading />}>
        <AuthWrapperAdmin>
          <Page title={"TEELAB | Quản lý người dùng"}>
  ...
  },
  {
    ...
    element: (
      <Suspense fallback={<Loading />}>
        <AuthWrapperAdmin>
          <Page title={"TEELAB | Quản lý đơn hàng"}>
  ...
  },
  {
    ...
    element: (
      <Suspense fallback={<Loading />}>
        <AuthWrapperAdmin>
          <Page title={"TEELAB | Quản lý đánh giá"}>
  ...
  },
  {
    ...
    element: (
      <Suspense fallback={<Loading />}>
        <AuthWrapperAdmin>
          <Page title={"TEELAB | Quản lý danh mục"}>
